...
export const getVersionName = (v: Version): string => {
	switch (v) {
		case Version.Dhh: return "Dios habla hoy";
		case Version.Nvi: return "Nueva version internacional";
		case Version.Rv95: return "Reina Valera 1995";
		case Version.Rv60: return "Reina Valera 1960";
	}
}
