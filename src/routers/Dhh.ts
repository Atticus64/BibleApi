...
import { Path, getChapterVersion, getEndpoits, getNewTestamentChapter, getoldTestamentChapterBook, testSearchVersion, SearchVersion } from "$/controllers/version.ts";
